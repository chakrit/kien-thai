...
[`notes/work-queue.md`](notes/work-queue.md) (agent-doable committed work). Consult it when
...
- [ ] **Phase 1 review** — the iter-8/9/10 `CLEAN` outputs. Needs your ear: skill-clean ≠
  ...
  → [`tests/REVIEW-PROTOCOL.md`](tests/REVIEW-PROTOCOL.md)
...
short — if something is agent-doable, it belongs in `notes/work-queue.md`, not here.
